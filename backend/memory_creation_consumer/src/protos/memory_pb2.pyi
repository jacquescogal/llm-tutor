...
class DBMemory(_message.Message):
    __slots__ = ("memory_id", "user_id", "doc_id", "memory_title", "memory_content", "created_time", "updated_time")
    MEMORY_ID_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    DOC_ID_FIELD_NUMBER: _ClassVar[int]
    MEMORY_TITLE_FIELD_NUMBER: _ClassVar[int]
    ...
    created_time: int
    updated_time: int
    def __init__(self, memory_id: _Optional[int] = ..., user_id: _Optional[int] = ..., doc_id: _Optional[int] = ..., memory_title: _Optional[str] = ..., memory_content: _Optional[str] = ..., created_time: _Optional[int] = ..., updated_time: _Optional[int] = ...) -> None: ...
