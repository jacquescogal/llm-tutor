...
class QuestionReturn(_message.Message):
    __slots__ = ("question_id", "user_id", "doc_id", "question_title", "question_serialized", "question_type", "created_time", "updated_time")
    QUESTION_ID_FIELD_NUMBER: _ClassVar[int]
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    DOC_ID_FIELD_NUMBER: _ClassVar[int]
    QUESTION_TITLE_FIELD_NUMBER: _ClassVar[int]
    QUESTION_SERIALIZED_FIELD_NUMBER: _ClassVar[int]
    QUESTION_TYPE_FIELD_NUMBER: _ClassVar[int]
    CREATED_TIME_FIELD_NUMBER: _ClassVar[int]
    UPDATED_TIME_FIELD_NUMBER: _ClassVar[int]
    question_id: int
    ...
    doc_id: int
    question_title: str
    question_serialized: str
    question_type: _common_pb2.QuestionType
    created_time: int
    updated_time: int
    def __init__(self, question_id: _Optional[int] = ..., user_id: _Optional[int] = ..., doc_id: _Optional[int] = ..., question_title: _Optional[str] = ..., question_serialized: _Optional[str] = ..., question_type: _Optional[_Union[_common_pb2.QuestionType, str]] = ..., created_time: _Optional[int] = ..., updated_time: _Optional[int] = ...) -> None: ...
